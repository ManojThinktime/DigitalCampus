...
public class BaseEndpoints {
	...
	public static RequestSpecification getRequestWithJSONHeadersToken(String token) {
        RequestSpecification r = RestAssured.given();



		//	r.contentType(ContentType.JSON);
			r.config(RestAssured.config().encoderConfig(encoderConfig().appendDefaultContentCharsetToContentTypeIfUndefined(false)));
